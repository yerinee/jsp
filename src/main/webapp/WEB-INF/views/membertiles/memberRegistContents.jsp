...
tiles: memberRegistContents.jsp

	<form id ="frm" class="form-horizontal" role="form" 
		method ="POST" action="${cp }/member/memberInsert" enctype="multipart/form-data">
	<!-- 1. 파일 업로드 경로를 이클립스내에 만든다.  -->
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10">
				<input id ="regBtn" type="button" class="btn btn-default" value ="사용자 등록"/>
			</div>
		</div>
	</form>
