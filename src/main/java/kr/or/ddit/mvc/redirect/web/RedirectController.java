...
public class RedirectController {
	...
	// localhost/redirect/process 보내면 ==> localhost/login/view로 요청됨 
	// 요청시 login.jsp로 리다이렉트 처리
	...
	public String process(Model model, HttpSession session, RedirectAttributes ra) {
		...
		// 리다이렉트 된 페이지에서 일회에 한해 사용할수 있는 속성
		...
		// "redirect:/login/view" ==> /login/viw?msg=hello, world
